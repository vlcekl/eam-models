...
***************Parameterisation of the interactions*********************
     ...
     $  rini,rfin,drar,rhoini,rhofin,drhoar,rcutsq,npoints,npoints1
      ...
      if(r.ge.r2) then ! Cubic spline part
        ...
        epair =  4525.61445d0*(2.22d0 - r)**3*H(2.22d0 - r)
     $          +107.488634d0*(2.46d0 - r)**3*H(2.46d0 - r)
     $          -15.2604631d0*(2.5648975d0 - r)**3*H(2.5648975d0 - r)
     $          +8.88626493d0*(2.629795d0 - r)**3*H(2.629795d0 - r)
     $          +10.7120352d0*(2.6946925d0 - r)**3*H(2.6946925d0 - r)
     $          +46.1310765d0*(2.8663175d0 - r)**3*H(2.8663175d0 - r)
     $          +6.70641338d0*(2.973045d0 - r)**3*H(2.973045d0 - r)
     $          -7.14000617d0*(3.0797725d0 - r)**3*H(3.0797725d0 - r)
     $          -2.02174483d0*(3.5164725d0 - r)**3*H(3.5164725d0 - r)
     $          +1.9897676d0*(3.846445d0 - r)**3*H(3.846445d0 - r)
     $          -1.35491449d0*(4.1764175d0 - r)**3*H(4.1764175d0 - r)
     $          -0.812592118d0*(4.700845d0 - r)**3*H(4.700845d0 - r)
     $          +1.99278451d0*(4.8953d0 - r)**3*H(4.8953d0 - r)
     $          -0.484145757d0*(5.089755d0 - r)**3*H(5.089755d0 - r)
     $          -0.0478673818d0*(5.3429525d0 - r)**3*H(5.3429525d0 - r)
     $          -1.46201396d0*(5.401695d0 - r)**3*H(5.401695d0 - r)
     $          +1.19810233d0*(5.4604375d0 - r)**3*H(5.4604375d0 - r)
     $          -0.00736954413d0*(5.54d0 - r)**3*H(5.54d0 - r)
     $          -0.00388205423d0*(5.58d0 - r)**3*H(5.58d0 - r)
     $          -0.00512566656d0*(5.62d0 - r)**3*H(5.62d0 - r)
        !call fdens(dens,r,1)
     ...
     $                    +0.2802d0*dexp(-0.4029d0*x)
     $                    +0.02817d0*dexp(-0.2016d0*x) )
        fun2 =  4525.61445d0*(2.22d0 - r)**3*H(2.22d0 - r)
     $          +107.488634d0*(2.46d0 - r)**3*H(2.46d0 - r)
     $          -15.2604631d0*(2.5648975d0 - r)**3*H(2.5648975d0 - r)
     $          +8.88626493d0*(2.629795d0 - r)**3*H(2.629795d0 - r)
     $          +10.7120352d0*(2.6946925d0 - r)**3*H(2.6946925d0 - r)
     ...
     $  rini,rfin,drar,rhoini,rhofin,drhoar,rcutsq,npoints,npoints1
      ...
      if(it.eq.1) then ! W EAM2
        ...
        if(r.le.2.1540054005400542) then
          ...
          dens=  3987.36133d0*(2.22d0 - r)**3*H(2.22d0 - r)
     $          +85.8053818d0*(2.5d0 - r)**3*H(2.5d0 - r)
     $          +31.7983469d0*(2.8663175d0 - r)**3*H(2.8663175d0 - r)
     $          -1.52861585d0*(3.1d0 - r)**3*H(3.1d0 - r)
     $          -1.77508182d0*(3.5d0 - r)**3*H(3.5d0 - r)
     $          +0.207405945d0*(4.62d0 - r)**3*H(4.62d0 - r)
          return
        endif
          dens=  3987.36133d0*(2.22d0 - r)**3*H(2.22d0 - r)
     $          +85.8053818d0*(2.5d0 - r)**3*H(2.5d0 - r)
...
C Gbonny Feb '10
      ...
      if(it.eq.1) then ! W EAM2
        ...
        if(rho.le.1.359141225d0) then
          embed = -4.1635311d0*ro**(0.5d0) - 0.00364115525d0*ro**2
        else
          embed = -4.1635311d0*ro**(0.5d0) - 0.00364115525d0*ro**2
        endif
        return
