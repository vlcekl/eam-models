...
***************Parameterisation of the interactions*********************
     ...
     $  rini,rfin,drar,rhoini,rhofin,drhoar,rcutsq,npoints,npoints1
      ...
      if(r.ge.r2) then ! Cubic spline part
        ...
        epair = -89.8973159d0*(2.5648975d0 - r)**3*H(2.5648975d0 - r)
     $          +158.30719d0*(2.629795d0 - r)**3*H(2.629795d0 - r)
     $          -71.2304117d0*(2.6946925d0 - r)**3*H(2.6946925d0 - r)
     $          +6.46096124d0*(2.8663175d0 - r)**3*H(2.8663175d0 - r)
     $          +0.342388839d0*(2.973045d0 - r)**3*H(2.973045d0 - r)
     $          +6.02193303d0*(3.0797725d0 - r)**3*H(3.0797725d0 - r)
     $          +1.71026053d0*(3.5164725d0 - r)**3*H(3.5164725d0 - r)
     $          +0.861616548d0*(3.846445d0 - r)**3*H(3.846445d0 - r)
     $          -1.24021132d0*(4.1764175d0 - r)**3*H(4.1764175d0 - r)
     $          -0.752778245d0*(4.700845d0 - r)**3*H(4.700845d0 - r)
     $          +2.16478392d0*(4.8953d0 - r)**3*H(4.8953d0 - r)
     $          -0.680500465d0*(5.089755d0 - r)**3*H(5.089755d0 - r)
     $          +0.00835831474d0*(5.3429525d0 - r)**3*H(5.3429525d0 - r)
     $          -1.70858135d0*(5.401695d0 - r)**3*H(5.401695d0 - r)
     $          +1.33828368d0*(5.4604375d0 - r)**3*H(5.4604375d0 - r)
        !call fdens(dens,r,1)
     ...
     $                    +0.02817d0*dexp(-0.2016d0*x) )
        ...
        fun2 = -89.8973159d0*(2.5648975d0 - r)**3*H(2.5648975d0 - r)
     $          +158.30719d0*(2.629795d0 - r)**3*H(2.629795d0 - r)
     $          -71.2304117d0*(2.6946925d0 - r)**3*H(2.6946925d0 - r)
     $          +6.46096124d0*(2.8663175d0 - r)**3*H(2.8663175d0 - r)
     $          +0.342388839d0*(2.973045d0 - r)**3*H(2.973045d0 - r)
     ...
     $  rini,rfin,drar,rhoini,rhofin,drhoar,rcutsq,npoints,npoints1
      ...
      if(it.eq.1) then ! W EAM2
        ...
        if(r.le.2.1540054005400542) then
          ...
          dens= +10.6188317d0*(2.5d0 - r)**3*H(2.5d0 - r)
     $          +2.26603603d0*(3.1d0 - r)**3*H(3.1d0 - r)
     $          -0.0152122221d0*(3.5d0 - r)**3*H(3.5d0 - r)
     $          +0.0200566458d0*(4.9d0 - r)**3*H(4.9d0 - r)
          return
        endif
          dens= +10.6188317d0*(2.5d0 - r)**3*H(2.5d0 - r)
     $          +2.26603603d0*(3.1d0 - r)**3*H(3.1d0 - r)
...
C Gbonny Feb '10
      ...
      if(it.eq.1) then ! W EAM2
        ...
        if(rho.le.1.359141225d0) then
          embed = -5.94255002d0*ro**(0.5d0) -0.00452753307*ro**2
        else
          embed = -5.94255002d0*ro**(0.5d0) -0.00452753307*ro**2
        endif
        return
